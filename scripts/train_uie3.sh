...
declare -A TASK2DATASETS=([re]="" [eet]="ace" [eea]="ace" [ner]="PolyglotNER_sample_20000")
#PolyglotNER WikiANN_en WikiNeural
...
do
    ...
    do
        ...
        --output_dir /storage_fast/zkhu/UIE-pp/output/${TASK_CONFIG}/${DATASET_CONFIG}/uie_base_fft \
        ...
        --save_strategy epoch \
        --resume_from_checkpoint /storage_fast/zkhu/UIE-pp/output/ner/PolyglotNER_sample_20000/uie_base_fft/best_model_for_PolyglotNER_sample_20000/ \
        #--save_strategy steps \
        #--save_steps 2 \
