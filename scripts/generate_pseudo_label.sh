...
declare -A TASK2DATASETS=([re]="finred" [eet]="ace" [eea]="ace" [ner]="ACE_2004")
...
do
    ...
    do
        CUDA_VISIBLE_DEVICES=0,1,3 python src/run_uie.py \
        --do_predict \
        --test_file /storage/zkhu/UIE-pp/data/ie_instruct/RE/finred/semval-RE_train_no_label.json \
        ...
        --output_dir /storage/zkhu/UIE-pp/output/re/finred_pseudo_label/ \
        ...
        --save_strategy epoch \
        --resume_from_checkpoint /storage_fast/zkhu/UIE-pp/output/re/finred/uie_fft/best_model_for_finred/ \
        #--group_by_length \
        #--save_strategy steps \
        #--save_steps 1000 \
