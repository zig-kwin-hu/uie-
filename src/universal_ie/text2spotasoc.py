...
from .utils import tokens_to_str
from .generation_format import GenerationFormat, StructureMarker
from .ie_format import Entity, Event, Label, Relation, Span
...
class Text2SpotAsoc(GenerationFormat):
    def __init__(self, structure_maker: StructureMarker, label_mapper: Dict = None) -> None:
        super().__init__(
